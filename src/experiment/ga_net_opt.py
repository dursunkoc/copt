...
def hard_initial_population(indiv_size: int, population_size: int, e_u:np.ndarray) -> np.ndarray:
     h = np.ones((population_size-1,) + indiv_size, dtype='int')
     return np.concatenate((h,e_u.reshape((1,*e_u.shape))))
...
#        next_generation = random_initial_population(indiv_size, population_size)   
        ...
        main(fn_fitness0=fn_fitness0, flat_indiv_size=case.indiv_size, next_generation=next_generation,
             indiv_size=(case.indiv_size,), generation_size=2000, population_size=max(80, case.indiv_size), check_back=5000,
...
Last login: Sat May 21 21:27:29 on ttys003
❯ workon copt
...
|population_size             : 10
|check_back                  : 50
|number_of_crossover_section : 2
|mutation_prob               : 1
|mutation_amount             : 1.0
|iterations completed        : 51
|Case: customer_size=10, Objective is: 6
---------------------------------------------------------------------------------
------------------------------Staring GA Solution------------------------------
|Parametes:
|indiv_size                  : (20,)
...
|mutation_amount             : 2.0
|iterations completed        : 51
|Case: customer_size=20, Objective is: 11
---------------------------------------------------------------------------------
------------------------------Staring GA Solution------------------------------
|Parametes:
|indiv_size                  : (50,)
...
|mutation_amount             : 5
|iterations completed        : 51
|Case: customer_size=50, Objective is: 23
---------------------------------------------------------------------------------
------------------------------Staring GA Solution------------------------------
|Parametes:
|indiv_size                  : (100,)
...
|mutation_amount             : 5
|iterations completed        : 51
|Case: customer_size=100, Objective is: 52
---------------------------------------------------------------------------------
------------------------------Staring GA Solution------------------------------
|Parametes:
|indiv_size                  : (200,)
...
|mutation_amount             : 5
|iterations completed        : 51
|Case: customer_size=500, Objective is: 250
---------------------------------------------------------------------------------
------------------------------Staring GA Solution------------------------------
|Parametes:
|indiv_size                  : (1000,)
